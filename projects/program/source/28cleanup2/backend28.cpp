...
void cleanup228::compute_fluid()
{
    ...
    UTIL2_TIME_NAMESPACE_MEASURE_CODE_BLOCK(g_computeCFLTime, compute_cfl_new(gr_nextIterVel));
...
static void compute_velocity() 
{
    ...
    u32 interactionTexOutput = gr_prevIterVel;
    if(addForce) 
    {
        interactionTexOutput = gr_outTexShader0; 
        ...
        gl::glBindTextureUnit(0, gr_prevIterVel);
        gl::glBindImageTexture(1, interactionTexOutput, 0, false, 0, 
            gl::GL_WRITE_ONLY,
            gl::GL_RGBA32F
        );
    ...
    gl::glBindTextureUnit(0, interactionTexOutput);
