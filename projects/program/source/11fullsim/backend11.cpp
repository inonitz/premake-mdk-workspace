...
static constexpr const char* computeShaderFilename[9] = {
    "projects/program/source/11fullsim/0externalforce.comp",
    "projects/program/source/11fullsim/1advection.comp",
    "projects/program/source/11fullsim/2diffusion.comp",
    "projects/program/source/11fullsim/3addition.comp",
    "projects/program/source/11fullsim/4divergence.comp",
    "projects/program/source/11fullsim/5diffusion2.comp",
    "projects/program/source/11fullsim/6velocity.comp",
    "projects/program/source/11fullsim/7draw.comp",
    "projects/program/source/11fullsim/parallelReduction.comp"
};
...
static i32                g_reductionFactor = 256;
...
static u32& g_reductionMinTexture = g_texture[14];
static u32& g_reductionMaxTexture = g_texture[15];
...
u8               program2::getContextID() { return g_contextid; }
util2::Time::Timestamp& program2::getFrameTime() { return g_frameTime; }
bool             program2::getSlowRenderFlag() { return g_slowRender; }


void program2::initializeLibrary()
{
...
void program2::initializeGraphics()
{
    u8 alive{true};
...
",
    ...
    winDimsStr,
    maxVelStr,
    (g_velocityCFL.x + g_velocityCFL.y) * g_dt
);
