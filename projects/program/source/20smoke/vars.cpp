...
const char* computeShaderFilename[9] = {
    "projects/program/source/20smoke/shaders/0force.comp",
    "projects/program/source/20smoke/shaders/1advect.comp",
    "projects/program/source/20smoke/shaders/2diffuse.comp",
    "projects/program/source/20smoke/shaders/3div.comp",
    "projects/program/source/20smoke/shaders/4pressure.comp",
    "projects/program/source/20smoke/shaders/5final.comp",
    "projects/program/source/20smoke/shaders/6draw.comp",
    "projects/program/source/20smoke/shaders/minmax.comp",
    "projects/program/source/20smoke/shaders/smoke.comp"
};
...
util2::Time::Timestamp    g_computeSmokeTime{};
...
f32   g_densityFactor      = 1.0f;
f32   g_ambientTemperature = 20.0f;
f32   g_temperatureFactor  = 1.0f;
f32   g_thermalDiffusivity = 1.0f;
f32   g_dt                 = 0.08f;
f32   g_prevdt             = g_dt;
f32   g_normdt             = g_dt;
f32   g_cfl                = 0.0f;
...
/*
    Compute/Simulation Related Constants
*/
...
ShaderProgramV2& gr_computeSmokeQuantities   = g_compute[8];
...
u32& gr_smokeTexture0 = g_texture[17]; /* components are [density, temperature, 0, 0] */
u32& gr_smokeTexture1 = g_texture[18]; /* components are [density, temperature, 0, 0] */
