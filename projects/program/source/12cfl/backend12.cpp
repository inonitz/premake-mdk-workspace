...
void program3::initializeLibrary()
{
...
void program3::initializeGraphics()
{
    u8 alive{true};
...
static void compute_velocity(u32 previousIteration, u32 nextIteration)
{
    ...
    */
    ...
    gr_computeAdd.uniform1f("ku_dt", g_dt);
